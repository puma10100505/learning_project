...
const std::string DefaultFontDirectory = solution_base_path + "Assets/Fonts/";
const std::string DefaultMeshDirectory = solution_base_path + "Assets/Meshes/";
const std::string DefaultDataDirectory = solution_base_path + "Assets/Data/";
const std::string DefaultLogDirectory = solution_base_path + "Bin/Logs/";
...
const std::wstring WideDefaultFontDirectory = wide_solution_base_path + L"Assets/Fonts/";
const std::wstring WideDefaultMeshDirectory = wide_solution_base_path + L"Assets/Meshes/";
const std::wstring WideDefaultDataDirectory = wide_solution_base_path + L"Assets/Data/";
const std::wstring WideDefaultLogDirectory = wide_solution_base_path + L"Bin/Logs/";
